    ...
    >
      ...
      <div className="px-2.5 pb-2.5">
        <button
          ...
          onClick={onToggle}
          aria-expanded={expanded}
          className={`w-full inline-flex items-center justify-center gap-2 min-h-[44px] px-3 py-2.5 rounded-lg text-sm font-bold shadow-md transition-colors ${
            expanded
              ? 'bg-neutral-800 text-white hover:bg-black border border-neutral-900'
