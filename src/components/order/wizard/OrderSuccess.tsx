...
export default function OrderSuccess({
  ...
  return (
    <div className="max-w-3xl mx-auto grid lg:grid-cols-2 gap-6 items-start">
      {/* z-10 keeps actions above the adjacent 3D card hit-target */}
      <div className="relative z-10 card border-brand-200 p-6 sm:p-8 text-center shadow-sm">
        ...
        <p className="text-sm text-neutral-500 mt-2">
          Your samples are queued for receiving. Track this order with the same Atlas Verified card.
        </p>
